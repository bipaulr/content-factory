...
function AnimatedCharactersSignupPage() {
  ...
  useEffect(() => {
    if (isTyping) {
      ...
      }, 800); // Look at each other for 800ms, then back to tracking mouse
      ...
      <div className="flex items-center justify-center p-8 bg-background overflow-y-auto">
        <div className="w-full max-w-[420px]">
          ...
          <div className="text-center mb-6">
            ...
            <p className="text-muted-foreground text-sm">Join us and start creating amazing content</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-3">
            {/* Error Message */}
            {error && (
              <div className="p-3 rounded-lg bg-destructive/10 border border-destructive/20 text-destructive text-sm animate-in fade-in-50 duration-200">
                {error}
              </div>
            )}
            ...
            <Button
              type="submit"
              disabled={isLoading}
              className="w-full h-12 mt-3 font-medium border border-primary bg-primary text-primary-foreground cursor-pointer hover:bg-primary/90"
            >
...
export default AnimatedCharactersSignupPage;
